...
class Menu{
    ...
    init(){
        ...
        var menu = document.querySelector(this.data.options.element)
    ...
    openWith(element, opener){
        ...
        if(element.startsWith('.')){
            ...
            var element = document.getElementsByClassName(element.substring(1));

            for(var i = 0; i < element.length; i++ ){

                element[i].addEventListener('click', function handleClick(event) {
